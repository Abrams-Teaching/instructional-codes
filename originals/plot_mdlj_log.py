...
parser.add_argument("-show-column-labels",default=True,type=bool,action='store_true',help="show column labels")
parser.add_argument("-do-flyvberg",default=False,type=bool,acion='store_true',help="Do Flyvberg analysis")
