...
parser.add_argument("-d",default=[2],type=int,nargs='+',help="space-separated-list of data columns to plot vs time")
...
parser.add_argument("-divide-by-N",default=False,action='store_true',help="Divide all y-data by N")
parser.add_argument("-fluc-in-leg",default=False,action='store_true',help="Include relative fluctuation of y-data in legend label")
...
cols=args.d #list(map(int,args.d.split(',')))
