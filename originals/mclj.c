...
void write_xyz(FILE * fp, double * rx, double * ry, double * rz, int n) {
  int i;
  fprintf(fp,"%i\n",n);
  fprintf(fp,"Generated by mclj.c; all elements are Ar\n");
  for (i=0;i<n;i++) {
    fprintf(fp,"Ar %.5lf %.5lf %.5lf\n",rx[i],ry[i],rz[i]);
  }
}
